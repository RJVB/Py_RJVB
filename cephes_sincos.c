// RJVB 20100428: cephes_sincos(x>450,0) has the sign of the cosine inversed (not when flg=1!)
// cephes_sincos(x>540,0) also has the sign of the sine inversed (not when flg=1!)
