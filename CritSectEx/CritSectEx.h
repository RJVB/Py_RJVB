...
extern CSEHandle *CreateCSEHandle(unsigned int dwSpinMax);
...
extern unsigned char LockCSEHandleWithTimeout(CSEHandle *cseH, unsigned int dwTimeout);
...
extern CSEScopedLock *ObtainCSEScopedLockWithTimeout(CSEHandle *cseH, unsigned int dwTimeout);
extern unsigned char LockCSEScopedLock(CSEScopedLock *scopeL);
extern unsigned char LockCSEScopedLockWithTimeout(CSEScopedLock *scopeL, unsigned int dwTimeout);
